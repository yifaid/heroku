...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
   ...
   conn.sendButton(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), await genProfile(conn, m), [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], false, { quoted: fkon, contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: "https://instagram.com/zetsunaaa._?igshid=YmMyMTA2M2Y=",
    mediaType: "VIDEO",
    description: "https://instagram.com/zetsunaaa._?igshid=YmMyMTA2M2Y=", 
    title: '𝐒𝐢𝐦𝐩𝐥𝐞 𝐁𝐨𝐭 𝐰𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐌𝐮𝐥𝐭𝐢-𝐃𝐞𝐯𝐢𝐜𝐞',
    body: wm,
    thumbnail: thumb,
    sourceUrl: sgc
}
} })
conn.sendFile(m.chat, vn, 'dj1.mp3', null, m, false, {
type: 'audioMessage', 
ptt: true 
})
